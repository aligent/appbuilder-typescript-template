# Telemetry Example Action

This example demonstrates various OpenTelemetry features via `@adobe/aio-lib-telemetry`:
...
Create `src/actions/telemetry-example/index.ts`:
...
See the [Telemetry section](../../../README.md#telemetry-opentelemetry) in the main README for full setup instructions including New Relic configuration.
